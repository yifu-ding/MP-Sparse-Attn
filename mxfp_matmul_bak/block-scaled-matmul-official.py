...
def initialize_block_scaled(M, N, K, block_scale_type="nvfp4", compute_reference=False):
    ...
    # a_scale = torch.ones((M // 128, K // VEC_SIZE // 4, 32, 4, 4), device=device) + epsilon
    # b_scale = torch.ones((N // 128, K // VEC_SIZE // 4, 32, 4, 4), device=device) + epsilon
...
if __name__ == "__main__":
    ...
    if False:
        ...
        validate_block_scaled(2048, 4096, 512, block_scale_type=args.format)
