...
from tests.modify_sage_attn_triton import set_sage_attn_8bit_llama
...
def main():
    ...
    parser.add_argument('--mmlu', action='store_true', help="evaluate on mmlu")
    ...
    model, tokenizer = init_llama_model(model_path=model_path, device=device)
    ...
    elif "sage_attn_8bit" in args.kernel_name:
        set_sage_attn_8bit_llama(model)
        print("replace sage_attn_8bit!")
